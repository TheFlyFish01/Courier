...
namespace MyAbpStudy.MultiTenancy
{
    ...
    {
        private readonly ICourierAppService _courierAppService;
        ...
        public TenantAppService(
            ICourierAppService _courierAppService,
            ...
            : base(repository)
        {
            this._courierAppService = _courierAppService;
